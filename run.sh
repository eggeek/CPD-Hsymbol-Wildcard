...
./bin/main -R -M maps/arena.map -S scens/arena.map.scen -I ./index_data/arena.map-DFS-3-subopt -L 3 --centroid -O arena3-subopt.out
...
./bin/main -R -M maps/brc000d.map -S scens/brc000d.map.scen -I ./index_data/brc000d.map-DFS-3-subopt -L 3 --centroid -O brc000d3-subopt.out
...
./bin/main -R -M maps/dao/brc101d.map -S scens/dao/brc101d.map.scen -I ./index_data/brc101d.map-DFS-3-subopt -L 3 --centroid -O brc101d3-subopt.out
