...
#g++ -ldl -std=c++0x -O3 -fopenmp -DNDEBUG -DUSE_PARALLELISM -DEXTRACT_ALL_AT_ONCE *.cpp -o src_jump_+_dfs
#g++ -std=c++0x -O3 -fopenmp -DNDEBUG -DUSE_PARALLELISM -DUSE_CUT_ORDER -DEXTRACT_ALL_AT_ONCE *.cpp -lmetis -o cut_src
g++ -ldl -std=c++0x -O3 -Xpreprocessor -fopenmp -lomp -DNDEBUG -DUSE_PARALLELISM -DEXTRACT_ALL_AT_ONCE *.cpp -o bin/src_jump_+_dfs
