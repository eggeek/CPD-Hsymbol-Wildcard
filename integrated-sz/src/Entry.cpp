...
void PreprocessMapPurely(std::vector<bool> &bits, int width, int height, const char *filename, int hLevel=1)
{
...
double GetPathCostSRCPurely(void *data, xyLoc s, xyLoc t, int hLevel, int limit) {
